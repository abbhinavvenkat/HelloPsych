...
#from xhtml2pdf import pisa (deprecated)
import StringIO, os, logging
#===============================================================================
#LOGGERS
#===============================================================================
class PisaNullHandler(logging.Handler):
    '''
        Adding a Null Handler to avoid the message:
...
def generate_pdf_template_object(template_object, \
    file_object, context, link_callback=fetch_resources):
    """
    ...
    pisa.CreatePDF(html.encode("UTF-8"), file_object, \
    show_errors_as_pdf=True, encoding='UTF-8',
...
context=None, link_callback=fetch_resources): # pragma: no cover
    """
    ...
    file_object, context, link_callback=link_callback)
    return file_object

def render_to_pdf_response(template_name, context=None, \
pdfname=None, link_callback=fetch_resources):
    ...
    return generate_pdf(template_name, file_object, \
    context, link_callback=link_callback)
