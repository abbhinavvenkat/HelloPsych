...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'prescription_prescription_medicines', (
        ...
        db.create_unique(u'prescription_prescription_medicines', ['prescription_id', 'dosage_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('prescription_prescription_medicines')
