...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'doctor.consultation_fee'
        db.add_column(u'login_doctor', 'consultation_fee',
                      self.gf('django.db.models.fields.IntegerField')(default=9),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'doctor.consultation_fee'
        db.delete_column(u'login_doctor', 'consultation_fee')
